...
#define MOVE_CURSOR_TO_XY(line, column) printf("\x1b[%zu;%zuH", line, column)
#define MOVE_CURSOR_UP(value) printf("\x1b[%zuA", value)
#define MOVE_CURSOR_UP_HOME(value) printf("\x1b[%zuF", value)
#define MOVE_CURSOR_DOWN(value) printf("\x1b[%zuB", value)
#define MOVE_CURSOR_DOWN_HOME(value) printf("\x1b[%zuE", value)
#define MOVE_CURSOR_RIGHT(value) printf("\x1b[%zuC", value)
#define MOVE_CURSOR_LEFT(value) printf("\x1b[%zuD", value)
